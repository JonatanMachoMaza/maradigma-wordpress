...
/**
 * Registers and renders the dynamic Gutenberg block for boat included.
 */
final class BoatIncludedBlock
{
    /**
    ...
    public static function render(array $attributes = [], string $content = '', $block = null): string
    {
        ...
        $shortcodeAttributes = GutenbergIntegration::pickAttributes($attributes, ['id', 'slug', 'title', 'show_title', 'show_tick_icon', 'tick_text', 'sort', 'fallback']);
...
GutenbergIntegration::registerBlock(__DIR__, [BoatIncludedBlock::class, 'render']);
