...
/**
 * Registers and renders the dynamic Gutenberg block for boat builder.
 */
final class BoatBuilderBlock
{
    /**
...
GutenbergIntegration::registerBlock(__DIR__, [BoatBuilderBlock::class, 'render']);
