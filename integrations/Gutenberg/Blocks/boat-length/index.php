...
/**
 * Registers and renders the dynamic Gutenberg block for boat length.
 */
final class BoatLengthBlock
{
    /**
...
GutenbergIntegration::registerBlock(__DIR__, [BoatLengthBlock::class, 'render']);
